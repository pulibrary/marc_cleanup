    ...
    Dir.glob("#{ROOT_DIR}/xml/*.xml") do |file|
      File.open("#{file}", 'r') do |input|
        File.open("#{ROOT_DIR}/logs/extra_spaces_bibs.log", 'a') do |output|
          while line = input.gets
            bib_id = line.gsub(/(^<record><leader>[^<]*<\/leader>)(<controlfield tag='001'>)([0-9]*)(<.+$)/, '\3')
            matchdata = line.scan(/(<datafield ind1='.' ind2='.' tag='[1-469]..'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='.'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)((?:<subfield code='.'>[^<]*<\/subfield>)*)(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='0[2-9].'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='.'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)(?:<subfield code='.'>[^<]*<\/subfield>)*(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='7[0-5].'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='.'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)(?:<subfield code='.'>[^<]*<\/subfield>)*(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='7[6-8].'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='[a-v3-8]'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)(?:<subfield code='.'>[^<]*<\/subfield>)*(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='8..'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='[^w7]'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)(?:<subfield code='.'>[^<]*<\/subfield>)*(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='5[0-24-9].'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='.'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)((?:<subfield code='.'>[^<]*<\/subfield>)*)(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='53[0-24-9]'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='.'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)((?:<subfield code='.'>[^<]*<\/subfield>)*)(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='533'>)(?:<subfield code='.'>[^<]*<\/subfield>)*((?:<subfield code='[^7]'>[^<]*[\s]{2,}[^<]*<\/subfield>)+)((?:<subfield code='.'>[^<]*<\/subfield>)*)(<\/datafield>)|(<datafield ind1='.' ind2='.' tag='[1-9]..'>)(?:<subfield code='.'>[^<]*<\/subfield>)*(?:<subfield code='.'>[^<]*[\s]+<\/subfield>)(<\/datafield>)/)
            unless matchdata.to_s == "[]"
              output.puts(bib_id)
            end
          end
